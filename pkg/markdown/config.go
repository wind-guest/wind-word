...
func (o *ConvertOptions) clone() *ConvertOptions {
	if o == nil {
		return DefaultOptions()
	}

	cloned := *o
	if o.StyleMapping != nil {
		cloned.StyleMapping = make(map[string]string, len(o.StyleMapping))
		for key, value := range o.StyleMapping {
			cloned.StyleMapping[key] = value
		}
	}
	if o.PageSettings != nil {
		pageSettings := *o.PageSettings
		cloned.PageSettings = &pageSettings
	}
